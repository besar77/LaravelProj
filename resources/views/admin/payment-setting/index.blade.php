                    ...
                    <div class="row p-2">
                        <div class="col-12 col-sm-12 col-md-2">
                            <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active show" id="paypal-tab4" data-toggle="tab"
                                        href="#paypal-setting" role="tab" aria-controls="paypal"
                                        aria-selected="true">Paypal</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="stripe-tab4" data-toggle="tab" href="#stripe-setting"
                                        role="tab" aria-controls="stripe" aria-selected="false">Stripe</a>
                                </li>
                                <li class="nav-item">
